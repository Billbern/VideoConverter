...
class User(Base):
    ...
    jobs = relationship("TranscodingJob", back_populates="user")
...
class Video(Base):
    ...
    transcoding_jobs = relationship("TranscodingJob", back_populates="video")
    processed_videos = relationship("ProcessedVideo", back_populates="video")
...
class TranscodingJob(Base):
    ...
    processed = relationship("ProcessedVideo", back_populates="job", uselist=False)
